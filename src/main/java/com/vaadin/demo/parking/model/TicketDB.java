...
public class TicketDB {
    ...
    //
    // private static ArrayList<Observation> observations = new
    ...
    // Species requestedSpecies, Location topLeft, Location bottomRight,
    // int maxResults) {
    //
    ...
    // }
    //
    // private static Location getRndPoint(Location topLeft, Location
    // bottomRight) {
    // if (topLeft == null) {
    ...
    // "Helsinki,Turku,Paimio,Mikkeli,Rovaniemi,Utsjoki,Kuusamo,Pello,Oulu,Kajaani,Pori,Kangasala,Utö,Hanko,Suonenjoki,Salo,Kisko,Vaajakoski,Lieksa"
    // .split(",");
    //
    // private static final int[] AMOUNTS = new int[] { 1, 1, 1, 1, 1, 1, 1, 1,
    // 1,
    ...
    // }
    //
    // public static BeanItemContainer<Observation> getObservationContainer(UI
    // ui) {
    // BeanItemContainer<Observation> beanItemContainer = new
    // BeanItemContainer<Observation>(
